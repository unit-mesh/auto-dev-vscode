...
export class TongyiLanguageModelProvider implements ILanguageModelProvider {
	readonly identifier = 'tongyi';
	...
	private _resolveChatModel(model?: string) {
		return model || this.configService.get<string>('tongyi.model', 'qwen-turbo');
	}
}
