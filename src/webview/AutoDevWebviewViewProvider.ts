...
<html lang="en">
  <head>
    ...
    <meta http-equiv="Content-Security-Policy" content="img-src ${panel.webview.cspSource} https://images.unsplash.com; script-src ${panel.webview.cspSource}; style-src ${panel.webview.cspSource};">
