...
import { Button, defaultBorderRadius, lightGray, vscBackground, vscForeground } from '../components'
...
import { setDialogEntryOn, setDialogMessage, setShowDialog } from '../redux/slices/uiStateSlice'
...
function fallbackRender({ error, resetErrorBoundary }) {
  ...
  return (
    <div role="alert" className="px-2" style={{ backgroundColor: vscBackground }}>
...
function GUI(props: GUIProps) {
  ...
  // #region Effects
  const [userScrolledAwayFromBottom, setUserScrolledAwayFromBottom] = useState<boolean>(false)
  ...
  const sendInput = useCallback(
    (editorState: JSONContent) => {
      ...
      if (counter) {
        ...
        localStorage.setItem('mainTextEntryCounter', (currentCount + 1).toString())
        if (currentCount === 300) {
          dispatch(
            setDialogMessage(
              <div className="text-center p-4">
                👋 Thanks for using Continue. We are a beta product and love working closely with
                our first users. If you're interested in speaking, enter your name and email. We
                won't use this information for anything other than reaching out.
                <br />
                <br />
                <form
                  onSubmit={(e: any) => {
                    ...
                    dispatch(
                      setDialogMessage(
                        <div className="text-center p-4">Thanks! We'll be in touch soon.</div>
                      )
                    )
                  }}
                  style={{
                      ...
                      <TimelineItem
                        ...
                        iconElement={
                          false ? (
                            ...
                            <ExclamationTriangleIcon width="16px" height="16px" color="red" />
                          ) : (
